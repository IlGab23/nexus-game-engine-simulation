...
public record RemoveInventoryItemCommand(Guid PlayerId, Guid ItemId, int Amount) : IRequest<Result<bool>>;

public sealed class RemoveInventoryItemCommandValidator : AbstractValidator<RemoveInventoryItemCommand>
{
    public RemoveInventoryItemCommandValidator()
    {
