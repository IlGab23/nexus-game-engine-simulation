...
public enum ErrorType { Failure, Validation, NotFound, Conflict, None }
...
public record Error(string Name, string Description, ErrorType Type, string[]? Details = null)
{
    ...
    public static Error NotFound(string Name, string Description, string[]? Details = null) => new(Name, Description, ErrorType.NotFound, Details);
